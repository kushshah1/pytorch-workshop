...
def gen_data(num): # Generates random input data, a length-n list: [(index, 100-residue sequence), ...]
    def rand_seq(length):
...
def main(): 
    ...
    # Prepare (inputs, targets): Input needs to be in form of per-sequence (token IDs, label)
    data = gen_data(500)
